...
function Ramzinex($coin){
    ...
    switch($coin){
        case "USDT" : $api_url .= "11";
            break;
        case "XRP" : $api_url .= "4";
            break;
        case "DOT" : $api_url .= "29";
            break;
        case "DOGE" : $api_url .= "10";
            break;
        case "XLM" : $api_url .= "19";
            break;
        case "EOS" : $api_url .= "76";
        ...
        case "BNB" : $api_url .= "17";
            break;
        case "MATIC" : $api_url .= "71";
            break;
        case "DAI" : $api_url .= "239";
            break;
        case "LTC" : $api_url .= "5";
            break;

        default : $api_url = Telegram("Ramzinex: Invalid Input!");
    }

    $response_data_sells = json_decode(file_get_contents($api_url."/sells?readable=0"));
    $response_data_buys = json_decode(file_get_contents($api_url."/buys?readable=0"));
